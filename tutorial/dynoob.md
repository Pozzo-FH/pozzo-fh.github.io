...
![Precap attempt by german APC failed](img/screen_precap.png){width=100%}
...
![Russian plan to camp at the lost flags disrupted](img/screen_camp.png){width=100%}

## Simple Gameplay example

We will see how exactly the gameplay works in a simple sectorpush
example, then we'll have a look at how to setup the plugin for this.
(Note that while the example is about sectorpush, this can work aswell
in a setup with objective destruction and sectors, like on hyacinth and
anctoville).
...
![](img/stage2_blank.svg){width=100%} 
